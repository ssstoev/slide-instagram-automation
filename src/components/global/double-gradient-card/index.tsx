...
function DoubleGradientCard({ label, subLabel, description }: Props) {
  return (
    <div className='relative border-[1px] border-in-active/50 p-5 rounded-xl flex flex-col gap-y-20 overflow-hidden'>
      ...
      <div className='w-6/12 h-full absolute radial--double--gradient--cards--top 
      top-0 left-0 z-10' />
      <div className='w-6/12 h-full absolute radial--double--gradient--cards--bottom
      top-0 left-1/2 right-0 z-0'/>
    </div>
  )
}
